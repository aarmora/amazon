System.register(['angular2/core', './order.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            DashboardComponent = (function () {
                function DashboardComponent(_router, _orderService) {
                ...
                DashboardComponent.prototype.ngOnInit = function () {
                    ...
                    this._orderService.getOrders()
                        .subscribe(function (res) { _this.orders = res.json(); });
